          ...
          <div className="col-12 col-lg-5">
            <div className="offer__content section__content">
              ...
              <h2 className="title title-anim">
                We Turn Your Business Some Great Ideas
              </h2>
              <div className="paragraph">
                <p>
                  From concept to final frame, we craft
                  animation and visual content that helps 
                  brand communicate clearly, emotionally,
                  and memorably
                </p>
              </div>
